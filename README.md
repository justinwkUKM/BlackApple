# AlamakCVLagi: AI-Powered Deep Research CV Studio and Career Intelligence
...
### 2. Rigorous Job Match and Qualification Scorecard
...
* **Match Score and Verdict (0-100%)**: Computes an objective alignment score categorized into match tiers (*Strong Match*, *Moderate Match*, *Skill Gap*).
...
### 3. Interactive CV Customizer and Studio
...
### 5. Tailored Cover Letter and Interview Preparation
...
### 6. Cloud Sync and Multi-Device History
...
| **Icons and UI** | Lucide React, Canvas Confetti |
| **Backend and API** | Node.js, Express, `tsx`, `esbuild` |
| **AI and LLM** | `@google/genai` (Google Gemini 2.5/3.7 Flash models) with Google Search grounding |
| **Database and Auth** | Firebase Authentication, Google Cloud Firestore |
...
* [ ] **Microsoft Word (.docx) and Plain-Text ATS Export**: One-click download for legacy enterprise job application portals.
* [ ] **LinkedIn PDF Profile Import**: Instant parsing of exported LinkedIn profiles into the ground-truth profile builder.
* [ ] **Skill Gap and Upskilling Recommendations**: Suggest specific certifications, open-source projects, or tech stacks to bridge gaps for dream roles.
